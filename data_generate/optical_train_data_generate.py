...
with tf.io.TFRecordWriter(tfrecord_file) as writer:
    ...
    for a in range(0, 10000, 200):
        for b in range(0, 10000, 50):
            ...
            cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display1\\"+str(count)+"_optical.tif",tran_optical_image)
            cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display1\\"+str(count)+"_sar.tif",sub_sub_sar/255)
            cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display1\\"+str(count)+"_label.tif",train_label_image)
