...
with tf.io.TFRecordWriter(tfrecord_file) as writer:
    ...
    for a in range(0, 10000, 200):
        for b in range(0, 10000, 200):
            ...
            rr,cc=draw.circle(circle_centrio_y,circle_centrio_x,40)
            label_iamge[rr,cc]=0.1

            rr1, cc1 = draw.circle(circle_centrio_y, circle_centrio_x, 30)
            label_iamge[rr1, cc1] = 0.4

            rr2, cc2 = draw.circle(circle_centrio_y, circle_centrio_x, 15)
            label_iamge[rr2, cc2] = 0.6

            rr3, cc3 = draw.circle(circle_centrio_y, circle_centrio_x, 7)
            label_iamge[rr3, cc3] = 0.8

            rr4, cc4 = draw.circle(circle_centrio_y, circle_centrio_x, 4)
            ...
            cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display6\\"+str(count)+"_optical.tif",tran_optical_image)
            cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display6\\"+str(count)+"_sar.tif",sub_sub_sar/255)
            cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display6\\"+str(count)+"_label.tif",train_label_image)
