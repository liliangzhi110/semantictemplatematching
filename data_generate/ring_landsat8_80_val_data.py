...
import cv2
filepath="E:\\fift_paper_dataset\\landset8\\landsat8_train_dataset.npz"
...
with tf.io.TFRecordWriter(tfrecord_file) as writer:
    for i in range(0, image1.shape[0]-260,50):
        for j in range(image1.shape[1]-1500,image1.shape[1]-260,50):
