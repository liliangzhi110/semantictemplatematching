    ...
    for i in range(0, image.shape[0]-400):
        for a in range(20, 255, 60):
            for b in range(20, 255, 60):
                ...
                cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display4\\"+str(count)+"_optical.tif",tran_optical_image)
                cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display4\\"+str(count)+"_sar.tif",sub_sub_sar/255)
                cv2.imwrite("E:\\fift_paper_dataset\\train_dataset\\display4\\"+str(count)+"_label.tif",train_label_image)
